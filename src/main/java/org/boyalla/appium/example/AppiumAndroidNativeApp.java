...
public class AppiumAndroidNativeApp {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		capabilities.setCapability(MobileCapabilityType.APP,
				"/Users/rave/Downloads/app-debug.apk");
		...
		WebElement search = driver.findElement(By.id("editText1"));
		
		//WebElement search = diver.findElementsByAccessibilityId("Search");
		search.sendKeys("raveendra");
		
		WebElement searchbutton = driver.findElement(By.id("switch1"));
